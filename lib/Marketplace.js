...
export const Marketplace = {
     ...
     *                                                                            occurs
     * @param {function(boolean)} onSuccess Callback to be called when the offer is submitted sucessfully
     */
    submitOffer(seller, issuanceID, price, amount, soldSeparately, negotiable, onError, onSuccess) {
        ...
        request('PUT', url, {loginAccount: seller, data: data}, onError, (data) => {
     ...
     * @param {function(object)} onError An error callback
     * @param {function(boolean)} onSuccess A success callback
     */
    sendMessage(sender, issuanceID, seller, content, onError, onSuccess) {
        ...
        request('POST', '/message', {loginAccount: sender, data: data}, onError, (data) => {
            onSuccess(data.pending);
        });
    }
};
