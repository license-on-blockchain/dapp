...
export const Marketplace = {
    _emails: {},
    /**
     * Get the email address that is associated with the given account on the LOB marketplace. This requires that the
    ...
    getEmailAddress(account) {
        if (!this._emails[account]) {
            this._emails[account] = new ReactiveVar(null);
