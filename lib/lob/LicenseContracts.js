...
export class LicenseContracts {
    ...
    _getField(licenseContractAddress, fieldName) {
        ...
        if (cachedValue) {
            ...
            licenseContract[fieldName]((error, value) => {
                ...
                this._licenseContracts.update({_id: licenseContractAddress, address: licenseContractAddress}, {$set: update});
            });
            return null;
        }
    }
    ...
    registerLicenseContract(licenseContractAddress) {
        if (!this._licenseContracts.findOne({address: licenseContractAddress})) {
            this._licenseContracts.insert({_id: licenseContractAddress, address: licenseContractAddress});
        }
