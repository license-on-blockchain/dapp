...
export class Issuances {
    ...
    getIssuancesOfLicenseContract(licenseContractAddress) {
        const licenseContract = this.licenseContracts.getLicenseContract(licenseContractAddress);
        const issuancesCount = licenseContract.issuancesCount.get();
        ...
        return this._issuances.find({licenseContract: licenseContractAddress});
    }
