...
export class Issuances {
     ...
     * @returns {{licenseContract: string, issuanceNumber: number, description: string, code: string, originalSupply: number, auditTime: number, auditRemark: string, revoked: boolean}}
     */
